          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => setStorage((p) => ({ ...p, startDate: e.target.value, endDate: p.endDate && p.endDate < e.target.value ? "" : p.endDate }))}
                className={inputClass}
              />
            </div>
            <div>
              ...
              <input
                ...
                min={storage.startDate || undefined}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setHousing((p) => ({ ...p, moveInDate: e.target.value, moveOutDate: p.moveOutDate && p.moveOutDate < e.target.value ? "" : p.moveOutDate }))}
                  className={inputClass}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  min={housing.moveInDate || undefined}

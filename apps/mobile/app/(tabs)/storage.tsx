...
export default function StorageScreen() {
  ...
  const handleSideSelect = useCallback(
    (value: string) => {
      feed.updateFilters({ side: (value || undefined) as "has_space" | "need_storage" | undefined });
    },
    [feed]
  );
  ...
  const header = (
    <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
      ...
      <FilterChips
        ...
        accentColor={colors.storage.primary}
      />
